...
<html>
    ...
    <body>
        <div class="top">
            <a class="back" href="index-admin.php?action=goToMenu"><em class="fas fa-arrow-left"></em> Menu</a>
        ...
        <div class="commentsToEdit">
            <h3>
                ...
                <em class="content"><?= $comment->getComment() ?></em>
            </h3>

            <a href="index-admin.php?action=commentToEdit&amp;id=<?= $comment->getId() ?>"><em class="fas fa-edit"></em> Modifier</a>
            <a href="index-admin.php?action=reportedCommentToDelete&amp;id=<?= $comment->getId() ?>"><em class="fas fa-times red"></em> Supprimer</a>
            <a href="index-admin.php?action=unflagComment&amp;id=<?= $comment->getId() ?>"><em class="fas fa-hand-paper green"></em> Enlever le report</a>
        </div>
    </body>
</html>
    <?php        endforeach;}
